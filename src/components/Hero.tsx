...
export default function Hero() {
  return (
    <section className="relative flex items-center justify-center py-20 md:py-40 px-4 md:min-h-screen">
      <motion.div
      ...
      >
        <motion.h1
          ...
          className="logo text-4xl lg:text-7xl font-bold tracking-wider mb-6"
        >
          Vinayak Gore
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-base md:text-xl text-foreground/80 max-w-3xl mb-8"
        >
        ...
        >
          ...
          <Button variant="outline" asChild size="lg" className="p-6 md:px-10 font-normal text-base hover:scale-110 transition-all duration-500">
